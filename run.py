...
gun = Gun(vm=700, alpha=77, gamma=30, l=10, yb=0, m=50, cd=30, sim="advanced")
wind = Wind(velocity=5, gamma=30)


data = gun.shoot(target=target, loop_interval=0.1, wind=wind)   # [0] = x, [1] = y, [2] = z
